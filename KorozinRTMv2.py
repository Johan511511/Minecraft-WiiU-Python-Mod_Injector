...
c = Checkbutton(window, text="Armor Hud", variable=cb2, onvalue=2, offvalue=3, command=armorHud)
c.grid(column=1, row=0)

c = Checkbutton(window, text="Craft All", variable=cb3, onvalue=3, offvalue=4, command=craftAll)
c.grid(column=2, row=0)

c = Checkbutton(window, text="Fly", variable=cb4, onvalue=5, offvalue=6, command=fly)
c.grid(column=3, row=0)

c = Checkbutton(window, text="FOF Bypass", variable=cb5, onvalue=7, offvalue=8, command=FOFbypass)
c.grid(column=4, row=0)

c = Checkbutton(window, text="Host Options", variable=cb6, onvalue=9, offvalue=10, command=host)
c.grid(column=0, row=1)

c = Checkbutton(window, text="Multi-Jump", variable=cb7, onvalue=11, offvalue=12, command=multiJump)
c.grid(column=1, row=1)

c = Checkbutton(window, text="Mute Mic", variable=cb8, onvalue=13, offvalue=14, command=muteMic)
c.grid(column=2, row=1)

c = Checkbutton(window, text="Reach", variable=cb9, onvalue=15, offvalue=16, command=reach)
c.grid(column=3, row=1)

c = Checkbutton(window, text="Unlock Keyboard", variable=cb10, onvalue=17, offvalue=18, command=keyboard)
c.grid(column=4, row=1)

c = Checkbutton(window, text="FOV", variable=cb11, onvalue=19, offvalue=20, command=FOV)
c.grid(column=0, row=2)

c = Checkbutton(window, text="Draw Hitbox", variable=cb12, onvalue=21, offvalue=22, command=Hitbox)
c.grid(column=1, row=2)

c = Checkbutton(window, text="Item Drop", variable=cb13, onvalue=23, offvalue=24, command=itemJava)
c.grid(column=2, row=2)

c = Checkbutton(window, text="Unlock Offhand", variable=cb14, onvalue=25, offvalue=26, command=offhand)
c.grid(column=3, row=2)

c = Checkbutton(window, text="Take All", variable=cb15, onvalue=27, offvalue=28, command=takeAll)
